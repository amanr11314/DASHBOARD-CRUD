                    ...
                    <?php if (!empty($errors['msg'])) { ?>
                        ...
                        <form method="POST" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]);  ?>">
                            <div class="form-group">
                                ...
                                <input name="email" type="email" class="form-control form-control-sm" id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="Email" value="<?php if (isset($_COOKIE["email"])) {
                                                                                                                                                                                            echo $_COOKIE["email"];
                                                                                                                                                                                        } ?>" ">
                            ...
                            <div class="form-group">
                                ...
                                <input type="password" name='password' placeholder="Password" class="form-control form-control-sm" id="exampleInputPassword1" value=<?php echo $_COOKIE['password']; ?>>
